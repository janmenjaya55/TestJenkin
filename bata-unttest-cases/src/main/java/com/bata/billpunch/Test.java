...
public class Test {
	 public  String sconcatTest(String a, String b) {
		 return a+b;
	 }

	public static void main(String[] args) throws ParseException {
		//StringConcatinterface ts=Test::sconcat();
		...
		Test tt=new Test();//create obj of that class
		StringConcatinterface px =tt::sconcatTest;
		
		System.out.println("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj>>>\"3\", \"3\""+px.sconcat("3", "4"));
