		...
		//reverse a string
		 ...
		 String substring="";
		   ...
		   StringBuilder sb=new StringBuilder(sx);  
		    ...
		    substring=substring+sx.substring( sx.length()-1)+sx.substring( sx.length()-2,sx.length()-1)+sx.substring( sx.length()-3,sx.length()-2)+sx.substring( sx.length()-4,sx.length()-3);
