...
public interface BillPunchDetailsDao extends JpaRepository<BillPunchDetailsModel, Long> {
	...
	@Query(nativeQuery = true, value = " select a.*  from  tt_bill_punch_dtls_one a  where a.bil_id=:id")
	...
	public List<BillPunchDetailsModel> findWithAllApprovedForSupplyReportFilternew(String partycode, String invno,String orderNo, String status);
	...
	public List<BillPunchDetailsModel> findWithAllApprovedForSupplyReportFilternewmanual(String partycode, String invno,String orderNo);
	...
	public List<BillPunchDetailsModel> findWithAllApprovedForSupplyReportFilternewold(String partycode, String invno,String orderNo, String status, String yr, String wk, String grNo);
	...
	// @Query(nativeQuery = true, value = "SELECT a.* FROM angular_service.tt_bill_punch_dtls_one a
	...
	// angular_service.tt_bill_punch_dtls_one a where a.C_WEEK like ?1 and a.STATUS='APPROVED'")
