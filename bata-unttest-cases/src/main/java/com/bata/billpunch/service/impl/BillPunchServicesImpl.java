...
public class BillPunchServicesImpl {
	...
	public BillPunchDetailsModel saveMock(BillPunchDetailsModel pm) {
		System.out.println("save mock data>>>>>>Code"+pm.getArticleCode());
		System.out.println("save mock data>>>>>>Name"+pm.getArticleName());
		return bdao.save(pm);
	...
	public List<BillPunchDetailsModel> getAll() {
		System.out.println("findWithAllMock data for dummy db>>>>>>>>>>>>>"+bdao.findWithAllMock().get(0).getArticleName());
		return bdao.findWithAllMock();
	}
   ...
   System.out.println("public BillPunchDetailsModel getById(Long id)"+ bdao.findWithIdMock(id));
		//return bdao.findById(id).get();
		return bdao.findWithIdMock(id);
	}
	...
	public List<BillPunchDetailsModel> findAllApprovedDetailsForSupplyReportFilternew(String partycode, String invno,
		...
		return bdao.findWithAllApprovedForSupplyReportFilternew(partycode, invno, orderNo, status);
	}
